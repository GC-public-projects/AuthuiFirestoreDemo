...
- the .gitignore file is the "android" one generated by github on June 2024. it includes for security purpose "google-services.json" and some other files not obligatory to compile the app.
